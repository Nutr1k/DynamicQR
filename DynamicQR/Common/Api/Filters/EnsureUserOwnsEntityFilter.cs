using Chirper.Common.Api.Results;
...
public class EnsureUserOwnsEntityFilter<TRequest, TEntity>(DynamicQrContext database, Func<TRequest, int> idSelector) : IEndpointFilter
